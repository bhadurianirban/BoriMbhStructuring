...
public class ReferencetextPK implements Serializable {
    ...
    public String toString() {
        return "org.dgrf.borimbhstructuring.entities.ReferencetextPK[ maintextParvaId=" + maintextParvaId + ", maintextAdhyayid=" + maintextAdhyayid + ", maintextShlokanum=" + maintextShlokanum + ", maintextShlokaline=" + maintextShlokaline + ", reftextid=" + reftextid + " ]";
    }
