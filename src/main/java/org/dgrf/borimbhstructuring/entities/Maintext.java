...
@NamedQueries({
    ...
    @NamedQuery(name = "Maintext.findByParvaId", query = "SELECT m FROM Maintext m WHERE m.maintextPK.parvaId = :parvaId"),
    @NamedQuery(name = "Maintext.findByAdhyayid", query = "SELECT m FROM Maintext m WHERE m.maintextPK.adhyayid = :adhyayid"),
    @NamedQuery(name = "Maintext.findByShlokanum", query = "SELECT m FROM Maintext m WHERE m.maintextPK.shlokanum = :shlokanum"),
    @NamedQuery(name = "Maintext.findByShlokaline", query = "SELECT m FROM Maintext m WHERE m.maintextPK.shlokaline = :shlokaline"),
    @NamedQuery(name = "Maintext.findByFirstchar", query = "SELECT m FROM Maintext m WHERE m.firstchar = :firstchar"),
    @NamedQuery(name = "Maintext.findByEndchar", query = "SELECT m FROM Maintext m WHERE m.endchar = :endchar"),
    @NamedQuery(name = "Maintext.findByLastupdatedts", query = "SELECT m FROM Maintext m WHERE m.lastupdatedts = :lastupdatedts")})
public class Maintext implements Serializable {
    ...
    public String toString() {
        return "org.dgrf.borimbhstructuring.entities.Maintext[ maintextPK=" + maintextPK + " ]";
    }
