 ...
 */
package org.dgrf.borimbhstructuring.entities;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Referencetext.findByMaintextParvaId", query = "SELECT r FROM Referencetext r WHERE r.referencetextPK.maintextParvaId = :maintextParvaId"),
    @NamedQuery(name = "Referencetext.findByMaintextAdhyayid", query = "SELECT r FROM Referencetext r WHERE r.referencetextPK.maintextAdhyayid = :maintextAdhyayid"),
    @NamedQuery(name = "Referencetext.findByMaintextShlokanum", query = "SELECT r FROM Referencetext r WHERE r.referencetextPK.maintextShlokanum = :maintextShlokanum"),
    @NamedQuery(name = "Referencetext.findByMaintextShlokaline", query = "SELECT r FROM Referencetext r WHERE r.referencetextPK.maintextShlokaline = :maintextShlokaline"),
    @NamedQuery(name = "Referencetext.findByReftextid", query = "SELECT r FROM Referencetext r WHERE r.referencetextPK.reftextid = :reftextid"),
    @NamedQuery(name = "Referencetext.findByReferencetextpos", query = "SELECT r FROM Referencetext r WHERE r.referencetextpos = :referencetextpos")})
public class Referencetext implements Serializable {
    ...
    public String toString() {
        return "org.dgrf.borimbhstructuring.entities.Referencetext[ referencetextPK=" + referencetextPK + " ]";
    }
