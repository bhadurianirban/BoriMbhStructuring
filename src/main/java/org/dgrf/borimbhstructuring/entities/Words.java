...
@NamedQueries({
    ...
    @NamedQuery(name = "Words.findByMaintextParvaId", query = "SELECT w FROM Words w WHERE w.wordsPK.maintextParvaId = :maintextParvaId"),
    @NamedQuery(name = "Words.findByMaintextAdhyayid", query = "SELECT w FROM Words w WHERE w.wordsPK.maintextAdhyayid = :maintextAdhyayid"),
    @NamedQuery(name = "Words.findByMaintextShlokanum", query = "SELECT w FROM Words w WHERE w.wordsPK.maintextShlokanum = :maintextShlokanum"),
    @NamedQuery(name = "Words.findByMaintextShlokaline", query = "SELECT w FROM Words w WHERE w.wordsPK.maintextShlokaline = :maintextShlokaline"),
    @NamedQuery(name = "Words.findByWordnum", query = "SELECT w FROM Words w WHERE w.wordsPK.wordnum = :wordnum"),
    @NamedQuery(name = "Words.findByWordtext", query = "SELECT w FROM Words w WHERE w.wordtext = :wordtext"),
    @NamedQuery(name = "Words.findByFirstchar", query = "SELECT w FROM Words w WHERE w.firstchar = :firstchar")})
public class Words implements Serializable {
    ...
    public String toString() {
        return "org.dgrf.borimbhstructuring.entities.Words[ wordsPK=" + wordsPK + " ]";
    }
