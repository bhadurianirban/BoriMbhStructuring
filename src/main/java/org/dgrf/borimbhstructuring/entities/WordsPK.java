...
public class WordsPK implements Serializable {
    ...
    public String toString() {
        return "org.dgrf.borimbhstructuring.entities.WordsPK[ maintextParvaId=" + maintextParvaId + ", maintextAdhyayid=" + maintextAdhyayid + ", maintextShlokanum=" + maintextShlokanum + ", maintextShlokaline=" + maintextShlokaline + ", wordnum=" + wordnum + " ]";
    }
